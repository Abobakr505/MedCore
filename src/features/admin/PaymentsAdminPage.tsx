...
{/* Header */} <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm"> <div className="absolute -right-20 -top-20 h-48 w-48 rounded-full bg-emerald-500/10 blur-3xl" /> <div className="absolute -bottom-24 left-10 h-48 w-48 rounded-full bg-brand-500/10 blur-3xl" />
        ...
        <div className="py-12">
          <EmptyState
            ...
            title={
              search
                ? "لا توجد نتائج"
                : "لا توجد طلبات دفع في هذا التصنيف"
            }
          />
        </div>
      </Card>
